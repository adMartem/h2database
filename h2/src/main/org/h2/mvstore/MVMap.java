...
//	 * a map migrated from some other data source. It may be used to add key-value pairs to an existing map, however, if any of the
//	 * keys to be appended already exist in the map, their value(s) will be replaced by the new value(s).
//	 * <p>
...
//	 */
//	public <F extends ValueFactory<V>, L extends List<KeyValue<K,?>>> void update(L keyValueList, F valueFactory) {
//		boolean isFinished;
...
//				}
//			} else {
//				// the key was found; replace the value
//				if (valueFactory != null) {
//					page.setValue(index, valueFactory.newInstance(initialKeyValue.getValue()));
//				} else {
//					page.setValue(index, initialKeyValue.getValue());
//				}
//			}
...
//					// the key was found; replace the value
//					if (valueFactory != null) {
//						page.setValue(index, valueFactory.newInstance(keyValue.getValue()));
//					} else {
//						page.setValue(index, keyValue.getValue());
//					}
//				}
//			}
//			return true;
